...
if not os.path.exists(build_dir):
    logwarn("Build Directory not found, creating new Directory")
    os.makedirs(build_dir)

if not os.path.exists(source_dir):
    logerr("Source Directory '{}' not found!".format(source_dir))
    error_count += 1
...
if build_settings.get('create-executable'):
    if not build_settings.get('program-entry'):
        logerr("No Program Entry Specified")
